<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="ONLINEORDER.Admin.Product" %>

<%@ Import Namespace="ONLINEORDER" %>
                                ...
                                <div class="card-block">
                                    <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Product Name Is Required"
                                                            ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtPName"></asp:RequiredFieldValidator>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                                            ErrorMessage="Quantity must be in decimal" ForeColor="Red" Display="Dynamic"
                                                ...
                                                <div class="form-group">
                                                   ...
                                                   <div>
                                                      ...
                                                      <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"  ErrorMessage="Category is required" 
                                                       ...
                                                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cs %>" SelectCommand="SELECT [CategoryId], [Name] FROM [tblCategories]"></asp:SqlDataSource>
                                        ...
                                        <div class="col-sm-6 col-md-8 col-lg-8 mobile-inputs">
                                            <h3 class="sub-title">Product List</h3>
                                                    ...
                                                    <asp:Repeater ID="rProduct" runat="server" OnItemCommand="rProduct_ItemCommand"
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img width="50" alt="" src='<%# Utils.GetImageUrl(Eval("ImageUrl")) %>' />
                                                                </td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CssClass="badge badge-danger" CausesValidation="false"

           ...
           if (isValidToExecute)
            {
                ...
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    actionName = userId == 0 ?
                   "Registration Successful!!.<b><a href='Login.aspx'>Click Here</a></b>to Login" :
                   "Details Updated Successfully!!.<b><a href='Profile.aspx'>Go To Profile</a></b>";
                    lblMsg.Visible = true;
                ...
                catch(SqlException ex)
                {
                    ...
                    {
                        lblMsg.Visible = true;
                        lblMsg.Text = "<b>" + txtUserName.Text.Trim() + "</b> UserName Already Exists!!.Enter New One.. ";
                         lblMsg.CssClass = "alert alert-danger";
                    }
                }
                catch (Exception ex)

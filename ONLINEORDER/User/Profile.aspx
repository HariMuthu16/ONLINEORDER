<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="ONLINEORDER.User.Profile" %>
                                    ...
                                    <div class="image-container">
                                        ...
                                        <div class="middle pt-3">
                                            <a href="Registration.aspx?id=<%Response.Write(Session["userId"]); %>" class="btn btn-warning">
                                                <i class="ti-pencil"></i>Edit Your Details
                                            </a>
                                        </div>
                                    ...
                                    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="connectedServices-tab" data-toggle="tab" href="#connectedServices" role="tab" aria-controls="connectedServices" aria-selected="false">
                                                <i class="fa fa-clock-o mr-2"></i>Purchase History</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content ml-1" id="myTabContent">
                                      <div class="tab-pane fade show active" id="basicInfo" role="tabpanel" area-labelledby="basciInfo-tab" >
                                      ...
                                      <div class="tab-pane fade" id="connectedServices" role="tabpanel" aria-lableledby="ConnectedServices-tab" >
                                          <h3>Order History</h3>
                                      </div>
                                    </div>
